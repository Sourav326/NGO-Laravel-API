...
<!--<![endif]-->
    <table class="wrapper" style="border-collapse: collapse;table-layout: fixed;min-width: 320px;width: 100%;background-color: #ffd92b;" cellpadding="0" cellspacing="0" role="presentation"><tbody><tr><td>
      ...
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #000;font-size: 34px;line-height: 43px;text-align: center;"><strong>The run to raise funds.</strong></h1><h3 style="Margin-top: 20px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #000;font-size: 18px;line-height: 26px;text-align: center;">The Read &amp; Speed&nbsp;event is the largest, most successful, 5K fundraiser for underserved schools worldwide.</h3><h3 style="Margin-top: 12px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #000;font-size: 18px;line-height: 26px;text-align: center;">Join us.</h3><h2 style="Margin-top: 12px;Margin-bottom: 16px;font-style: normal;font-weight: normal;color: #000;font-size: 28px;line-height: 36px;text-align: center;"><strong>{{$details['otp']}}</strong></h2>
      </div>
    </div>
      ...
      <div style="background-color: #ffd92b;">
        <div class="layout two-col stack" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000% - 167400px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
          ...
          <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr class="layout-full-width" style="background-color: #ffd92b;"><td class="layout__edges">&nbsp;</td><td style="width: 300px" valign="top" class="w260"><![endif]-->
      ...
      <div style="mso-line-height-rule: exactly;line-height: 30px;font-size: 1px;">&nbsp;</div>
              ...
              <div style="Margin-left: 20px;Margin-right: 20px;">
      <div style="mso-line-height-rule: exactly;mso-text-raise: 11px;vertical-align: middle;">
        <p style="Margin-top: 0;Margin-bottom: 0;">Over a decade ago, Helping Hand&nbsp;started with a single goal - &nbsp;to help underserved students in every country. There are thousands of other&nbsp;amazing causes too so we were thrilled to&nbsp;see over 5,000 people at our last Read and Speed event.</p><p style="Margin-top: 20px;Margin-bottom: 0;">Before the kick-off, we talked to publishing firms, shipping companies, teachers, and software engineers. Our goal was to raise $600,000 to help&nbsp;100 schools that we had not been able to help&nbsp;before. We raised over $750,000.</p><p style="Margin-top: 20px;Margin-bottom: 0;">Our success came from individuals like you. You not only brought friends and family to the event, but secured an average of eight&nbsp;personal sponsors for your participation.</p><p style="Margin-top: 20px;Margin-bottom: 20px;">It&#8217;s so exciting. Let's see 
how much more we can do together this time.</p>
      </div>
    </div>
